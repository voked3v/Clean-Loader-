...
namespace ImGui
{
    ...
    IMGUI_API ImU32 GetColorU322(const ImVec4& col, float alpha_mul);
    ...
    IMGUI_API bool Checkboxx(const char* label, bool* v, float fixed_width);
    IMGUI_API bool          KeyBind(const char* label, int* Key, int* KeyState);
    IMGUI_API bool          Tab(const char* Label, bool Enabled);
