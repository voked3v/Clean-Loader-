...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags) {
    ...
    // Render
    it_anim->second.background = ImLerp(it_anim->second.background, IsItemActive() || hovered ? ColorConvertU32ToFloat4(ImColor(99, 41, 206)) : ColorConvertU32ToFloat4(ImColor(99, 41, 206)), 0.2f);
